...
// GiveExp mocks base method
func (m *MockUser) GiveExp(ctx context.Context, user *entity.User, exp int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GiveExp", ctx, user, exp)
	ret0, _ := ret[0].(error)
	return ret0
}

// GiveExp indicates an expected call of GiveExp
func (mr *MockUserMockRecorder) GiveExp(ctx, user, exp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GiveExp", reflect.TypeOf((*MockUser)(nil).GiveExp), ctx, user, exp)
}
